...
internal sealed class ActivityCatalogue : IActivityCatalogue
{
    ...
    public void Register<TInput, TOutput>(ActivityReference reference, IActivity<TInput, TOutput> implementation)
    {
        ...
        {
            Reference = reference,
            Input = new ActivityContract { ClrType = typeof(TInput) },
            Output = new ActivityContract { ClrType = typeof(TOutput) }
        };
